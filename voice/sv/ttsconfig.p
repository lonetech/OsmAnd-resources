...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ROUTE CALCULATED
string('route_is.ogg', 'Resan är ').
string('route_calculate.ogg', 'Ny väg beräknad').
...
string('4th.ogg', 'fjärde ').
string('5th.ogg', 'femte ').
string('6th.ogg', 'sjätte ').
string('7th.ogg', 'sjunde ').
string('8th.ogg', 'åttonde ').
string('9th.ogg', 'nionde ').
string('10th.ogg', 'tionde ').
string('11th.ogg', 'elfte ').
string('12th.ogg', 'tolfte ').
string('13th.ogg', 'trettonde ').
string('14th.ogg', 'fjortonde ').
string('15th.ogg', 'femtonde ').
string('16th.ogg', 'sextonde ').
...
roundabout(Dist, _Angle, Exit, Street) -- ['in.ogg', D, 'roundabout.ogg', E, 'exit.ogg' | Sgen] :- distance(Dist) -- D, nth(Exit, E), turn_street(Street, Sgen).
